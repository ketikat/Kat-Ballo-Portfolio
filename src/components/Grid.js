...
function GridImage (props) {
  ...
  const {  link, url, morphId, index, padding, imgFitting, paddingBottom, clickHandler, clickParam } = props
...
// styles
  const styles = {
    ...
    imageWrapper: {
      ...
      cursor: 'pointer',
      clipPath: `url(#${morphId}Clip)`,
      WebkitClipPath: `url(#${morphId}Clip)`,
    }
  }
  ...
  return(
        ...
        <div id={morphId} className='imageGridItem' style={styles.imageGridItem}>
