        ...
        <div id='menuToggle' className={toggled}>
          ...
          <ul id='menu' className={toggled}>
            <div id='websiteLinks'>
              ...
              <div id='projectLinks'>
                <br />
                <p onClick={this.burgerClicked} className='offsetItem'>
                  <Link to='/work/exquisite_graveyard'>
                    Exquisite Graveyard
                  </Link>
                </p>
                <p onClick={this.burgerClicked} className='offsetItem'>
                  <Link to='/work/iloveplant'>I Love Plant</Link>
                </p>
                <p onClick={this.burgerClicked} className='offsetItem'>
                  <Link to='/work/d_construction'>D-Construction</Link>
                </p>
                <p onClick={this.burgerClicked} className='offsetItem'>
                  <Link to='/work/artist_portfolio'>
