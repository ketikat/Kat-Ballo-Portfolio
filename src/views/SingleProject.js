    ...
    switch (title) {
      case 'iloveplant':
        ...
        text = (
          <span>
            <p>
              An e-commerce plant store selling...plants! Includes client as
              well as Admin sites.
              <br />
              <br />
              Built as part of a four person team of developers in a one week
              sprint with Node.js, Express.js, Sequelize, React-Redux,
              Bootstrap, Mocha, and Chai, and hosted with Heroku.
            </p>
          </span>
        )
        break
      ...
      case 'exquisite_graveyard':
        ...
        text = (
          <span>
            <p>
              Exquisite Graveyard is an interactive drawing game that was
              modeled on the Exquisite Corpse game played by surrealist artists
              like Andre Breton & Salvador Dali in the 1920’s. This progressive
              web app allows you to draw exquisite corpses with your friends
              online.
              <br />
              <br />
              Built as part of a four person team of developers in a two week
              sprint with Node.js, Express.js, React, Cloud Firestore, and
      ...
      case 'd_construction':
        ...
        text = (
          <span>
            <p>
              D-Construction developed around the letter D. I designed and
              constructed my own typekit to look like it was cut out of
              construction paper. All of the letters in the alphabet are
              constructed from various forms of the letter D; hence the title
              “D-Construction”.
              <br />
              <br />
              Built with Node.js, Express.js, and React-Redux, and hosted with
              Firebase.
            </p>
          </span>
        )
